            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-sm mx-auto">
                <form>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="name" type="text" className="form-input w-full text-dark-900" placeholder="Enter your name" required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                ...
                <div className="text-white text-center mt-6">
                  Already using Simple? <Link to="/signin" className="text-teal-400 hover:underline transition duration-150 ease-in-out">Sign in</Link>
                </div>
              </div>
